      ...
      <div id="content">
        <div class="container">
          ...
          <div class="col-md-9">
            <div class="box">
              <h1>Mobiles</h1>
              <p>In our Mobiles department we offer wide selection of the best products
                we have found and carefully selected worldwide.</p>
            </div>
            <div class="box info-bar">
              <div class="row">
                <div class="col-sm-12 col-md-4 products-showing">Showing
                  <strong>12</strong>of
