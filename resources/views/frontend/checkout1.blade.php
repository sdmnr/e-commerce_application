            ...
            <div class="box">
              ...
              <input type="hidden" name="_token" value="{{csrf_token()}}" />
                ...
                <ul class="nav nav-pills nav-justified">
                  <li class="active">
                    <a href="#"><i class="fa fa-map-marker"></i><br>Address</a>
                  </li>
                  <li class="disabled">
                ...
                <div class="box-footer">
                  <div class="pull-left">
                    <a href="basket" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to basket</a>
                  </div>
                  <div class="pull-right">
                    <button type="submit" class="btn btn-primary">Continue to Delivery Method
